...
.faq-q { font-weight: 600; color: #50837a;}
.soporte-chat {
    background:#eaf6f0;
    border-radius:12px;                       
...
.chat-form label {
    font-size:.97em; font-weight:600; color:#274c3d;
    margin-bottom:3.5px;display:block;
}
.chat-form input, .chat-form textarea {
    width: 100%; border-radius:7px; border:1.1px solid #97d6b2;                                
    padding: 12px; font-size: 1.07em; background: #f8fafb;
}
.chat-form textarea { min-height: 62px; max-height: 160px; resize: vertical;}
.chat-form button {
    background: linear-gradient(90deg,#5e947a 0,#406d56 95%);
    color:#fff;padding:12px 0;border:none;border-radius:8px;
    font-weight:600;width:100%;font-size:1.14em;cursor:pointer;
    transition: background .22s;
}
.chat-form button:hover { background:linear-gradient(85deg,#436d63 5%,#7bb891 95%)}
.msg-enviado {
    background: #e0ffe5; color: #206843;
    border:1px solid #b7ebbc;
    margin-bottom:13px; border-radius:8px; padding:12px; text-align:center;
    font-weight:600;
}
</style>
...
<main class="soporte-wrap">
    ...
    <div class="faqs">
    <div class="faq-item">
        <span class="faq-q">¿Cómo registrar mi perfil en TypeJobs?</span><br>
    ...
    <div class="faq-item">
        ...
        Busca en <a href="<?= BASE_URL ?>/servicio">Servicios</a>, ver detalles y contáctalo desde el botón "Contactame".
    </div>
    <div class="faq-item">
        <span class="faq-q">¿Cómo calificar a un profesional?</span><br>
    ...
    <div class="faq-item">
        <span class="faq-q">¿Cómo editar mi perfil o servicios?</span><br>
    ...
    <div class="faq-item">
        ...
        Sí eres un cliente,puedes cancelar la reserva en la pestaña <a href="<?= BASE_URL ?>/cliente/reservas">Mis Reservas</a>.
    </div>
    <div class="faq-item">
