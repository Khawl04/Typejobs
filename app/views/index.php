...
.hero {
    ...
    background: linear-gradient(120deg, #e8e4d9 80%, #e3fbef 100%);
    padding: 0 20px;
    position: relative;
}
.hero-content {
...
<main class="hero">
    <div class="hero-content">
        ...
        <p class="hero-subtitle">Bienvenido a la plataforma de servicios freelance donde los mejores profesionales y empresas se conectan.<br> Encontrá talento o hacé crecer tu negocio rápidamente.</p>
